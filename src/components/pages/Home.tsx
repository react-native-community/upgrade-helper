...
export function Home() {
	return (
		<div className="mx-8">
			<div className="flex flex-col mt-8 p-6 border">
				<div className="flex items-center">
					<img
						...
						src={logo}
					/>
					<a href={homepage} className="mr-4">
						<h1 className="text-3xl">React Native Upgrade Helper</h1>
					</a>
				...
				<div className="flex justify-center my-8">
					<div className="flex flex-col flex-1 mr-6">
						...
						<Select options={[{ label: "0.65.7", id: "0.65.7" }]} />
					</div>
